...
d1 <- read.csv(
  "/fs/data3/ecowdery/ED.Hydro/parameters/constraint_calculations/constraint_data/Lin_2015/tropicaldata_stomatal_slope.csv",
...
which(insert_dat$value < min(stomatal_slope_prior))
which(insert_dat$value > max(stomatal_slope_prior))
